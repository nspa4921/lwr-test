    ...
    function elementDataBag(element) {
        ...
        if (props) {
            for (const [key, value] of Object.entries(props)) {
                propsObj.properties.push(t.property(t.literal(key), computeAttrValue(value, element)));
            }
        }
        // Properties: lwc:inner-html directive
        if (element.lwc && element.lwc.innerHTML) {
            const expr = typeof element.lwc.innerHTML === 'string'
                ? t.literal(element.lwc.innerHTML)
                : (0, scope_1.bindExpression)(element.lwc.innerHTML, element, parentStack);
            propsObj.properties.push(t.property(t.identifier('innerHTML'), codeGen.genSanitizedHtmlExpr(expr)));
        }
        if (propsObj.properties.length) {
            data.push(t.property(t.identifier('props'), propsObj));
        }
        // Context
        if ((lwc === null || lwc === void 0 ? void 0 : lwc.dom) || (lwc === null || lwc === void 0 ? void 0 : lwc.innerHTML)) {
