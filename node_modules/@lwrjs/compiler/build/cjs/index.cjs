...
var import_minification = __toModule(require("./minification.cjs"));
...
var LwrCompiler = class {
  ...
  minifyJavascript(source) {
    return (0, import_minification.minify)(source);
  }
  minifyCSS(source) {
    return (0, import_minification.minify)(source, {fileType: "css"});
  }
};
