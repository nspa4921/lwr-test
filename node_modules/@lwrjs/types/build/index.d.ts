...
import { BundleConfig, EnvironmentConfig, HooksPlugin, LwrLockerConfig, NormalizedLwrErrorRoute, NormalizedLwrGlobalConfig, NormalizedLwrRoute, ResolverModuleRecord, RouteHandlerFunction, RouteHandlerView, View } from './config.js';
...
export declare type RuntimeParams = Record<string, string | number | boolean | null | undefined>;
...
declare type TransformPluginContext = Record<string, any>;
