...
(function () {
  ...
  class LoaderShim {
      constructor(global) {
          ...
          this.loaderModule = 'lwr/loaderLegacy/v/0_6_5';
      ...
      createProfilerModule(loader) {
          ...
          loader.define('lwr/profiler/v/0_6_5', ['exports'], exporter, {});
      }
  ...
  if (GLOBAL.LWR.requiredModules.indexOf('lwr/loaderLegacy/v/0_6_5') < 0) {
      GLOBAL.LWR.requiredModules.push('lwr/loaderLegacy/v/0_6_5');
  }
  new LoaderShim(GLOBAL);

}());

LWR.define('lwr/loaderLegacy/v/0_6_5', ['exports'], function (exports) { 'use strict';
